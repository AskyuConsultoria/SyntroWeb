async function ContagemKpiNotas() {
    try {
        const responseNaoIniciada = await fetch('http://localhost:8080/syntro/nota-fiscal/status/1');
        ...
        const responseEmAndamento = await fetch('http://localhost:8080/syntro/nota-fiscal/status/2');
